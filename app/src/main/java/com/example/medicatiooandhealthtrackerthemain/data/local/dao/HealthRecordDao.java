...
public interface HealthRecordDao {
    ...
    LiveData<List<HealthRecord>> getRecordsInRange(int userId, long startTime, long endTime);
    ...
    default LiveData<List<HealthRecord>> getVitalSignsByTypeInRange(
            int userId, String vitalType, long startTime, long endTime) {
        return null;
    }
    ...
    LiveData<List<HealthRecord>> getSymptomsInRange(
            int userId, long startTime, long endTime);
