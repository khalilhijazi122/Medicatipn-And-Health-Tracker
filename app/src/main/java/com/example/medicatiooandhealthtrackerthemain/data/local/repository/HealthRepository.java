...
public class HealthRepository {
     ...
     */
    public LiveData<List<HealthRecord>> getRecordsInRange(String userId, long startTime, long endTime) {
     ...
     */
    public LiveData<List<HealthRecord>> getHeartRateRecords(String userId, long startTime, long endTime) {
     ...
     * Get weight records
     */
    public LiveData<List<HealthRecord>> getWeightRecords(String userId, long startTime, long endTime) {
     ...
     * Get symptom records
     */
    public LiveData<List<HealthRecord>> getSymptoms(String userId, long startTime, long endTime) {
